...
function B_Section_four_img() {
    return (
        <section className="overflow-x-hidden text-gray-700 relative bg-lite_primary_bg">
            <div className="md:py-36 md:flex-row px-4 sm:px-8 md:px-4 xl:px-0 max-w-screen-xl flex flex-col items-center mx-auto">
                <div className="my-1 md:w-1/2 md:mb-0 flex flex-col items-start mb-16 text-left">
                    ...
                    <Link
                        to="/auth/register"
                        className=" px-8 py-4 font-semibold rounded text-base text-white bg-primary focus:outline-none md:mt-0 inline-flex items-center border-0 mt-4"
                    >
                        Start earning
                    </Link>
                </div>
