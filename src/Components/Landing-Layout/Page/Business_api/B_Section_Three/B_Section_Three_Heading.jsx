...
function B_Section_Three_Heading() {
    return (
        <section className="text-gray-900">
            <div
                className="max-w-screen-xl mx-auto px-4 sm:px-8 md:px-4 xl:px-0"
                id="services"
            >
                <div className="flex flex-col justify-center pt-20 sm:pt-24 md:pt-20 items-center">
                    ...
                    <div className="text-gray-600 tracking-wide font-normal leading-none text-center text-base">
                        The 3 Key steps to getting an API.
                    </div>
                </div>
            </div>
        </section>
...
export default B_Section_Three_Heading;
